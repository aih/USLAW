# -*- coding: utf-8 -*-
# Uslaw Project
# Load Forms and instructions from http://www.irs.gov/app/picklist/list/formsInstructions.html
# 
...
from laws.models import FormAndInstruction, TextStore
...
class Command(BaseCommand, BasePlugin):
    ...
    sender = "FormAndInstructions parser"
    ...
    def process_page(self, page):
        ...
        if page.plugin_level == 0: #  Top page
            ...
            for d in documents:
                ...
                fai, c = FormAndInstruction.objects.get_or_create(link=d[0].strip(),
