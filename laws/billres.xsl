...
<!--  VERSION:   2.6                                               -->
<!--  DATE:      June 22, 2010                                     -->
<!--  Previous version and date: 2.5 December 22, 2009               -->
<!-- ============================================================= -->
...
<!--	<xsl:include href="table.xsl"/>-->
		...
		<xsl:if test="not(@display='no')">
			...
			<xsl:choose>
				...
				<xsl:when
					...
					<br/>
					<br/>
					<xsl:if test="not(current-chamber/@display='no') and not (parent::form/@display='no') or not (action/action-date/@display='no')">
						<hr width="40%"/>
					</xsl:if>
	...
	<xsl:template name="displayEnumSection">
		...
		<xsl:choose>
			<xsl:when
				test="parent::section/parent::constitution-article/parent::quoted-block/@style='traditional' or parent::section/parent::constitution-article/parent::quoted-block/@style='traditional'='appropriations'">
				<!--xsl:text>“</xsl:text-->
	...
	<xsl:template name="toCloseTheBrakets">
		...
		<!--xsl:choose>
			...
			<xsl:when
				test="(following-sibling::*[1]/text() or  following-sibling::*[1]/text or following-sibling::*[1]/child::*/text()) and not(following-sibling::*[1][(@changed='deleted' or (not(@changed) and $isAncestorDeleted='true')) and ($ReportedDisplayStyle ='bold-brackets' or (not (@reported-display-style) and $isAncestorDeleted='true'))])  and $isChildLast='true'">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<xsl:when
				test="not(following-sibling::*) and (ancestor::*[1]/following-sibling::*[1]/text != '' or ancestor::*[1]/following-sibling::*[1]/text() or ancestor::*[1]/following-sibling::*[1]/child::*/text() ) and not(ancestor::*[1]/following-sibling::*[1][(@changed='deleted' or (not(@changed) and $isAncestorDeleted1='true')) and ($ReportedDisplayStyle ='bold-brackets' or (not (@reported-display-style) and $isAncestorDeleted1='true'))	] ) and $isChildLast='true'">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<xsl:when
				test="not (ancestor::*[1]/following-sibling::*) and ancestor::*[2]/following-sibling::*[1]/text != ''  and not(ancestor::*[2]/following-sibling::*[1][(@changed='deleted' or (not(@changed) and $isAncestorDeleted2='true')) and ($ReportedDisplayStyle ='bold-brackets' or (not (@reported-display-style) and $isAncestorDeleted2='true'))] ) and $isChildLast='true'">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<xsl:when
				test="not (ancestor::*[2]/following-sibling::*) and ancestor::*[3]/following-sibling::*[1]/text != ''  and (ancestor::*[3]/following-sibling::*[1][(@changed='deleted' or (not(@changed) and $isAncestorDeleted3='true')) and ($ReportedDisplayStyle ='bold-brackets' or (not (@reported-display-style) and $isAncestorDeleted3='true'))]) and $isChildLast='true' ">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<xsl:when
			...
			<xsl:when
				test="not (ancestor::*[4]/following-sibling::*) and ancestor::*[5]/following-sibling::*[1]/text != '' and ancestor::*[5]/following-sibling::*[1][(@changed='deleted' or (not(@changed) and $isAncestorDeleted5='true')) and ($ReportedDisplayStyle ='bold-brackets' or (not (@reported-display-style) and $isAncestorDeleted5='true'))] and $isChildLast='true' ">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<xsl:when
				test="not (ancestor::*[5]/following-sibling::*) and ancestor::*[6]/following-sibling::*[1]/text != '' and ancestor::*[6]/following-sibling::*[1][(@changed='deleted' or (not(@changed) and $isAncestorDeleted6='true')) and ($ReportedDisplayStyle ='bold-brackets' or (not (@reported-display-style) and $isAncestorDeleted6='true'))]  and $isChildLast='true' ">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<xsl:when
			...
			<xsl:when
				test="not (following-sibling::*) and local-name(parent::*/following-sibling::*[1])='after-quoted-block' and not (parent::*/following-sibling::*[2][@changed='deleted'  or not(@changed) and ($ReportedDisplayStyle ='bold-brackets'  or not (@reported-display-style))]) ">
				<xsl:text>yes</xsl:text>
			</xsl:when>
			<xsl:when test="local-name()='deleted-phrase'">
				<xsl:text>yes</xsl:text>
	...
	<xsl:template name="LastElementClosed">
		<xsl:variable name="possibleElementName">
			<xsl:text>,section,subsection,paragraph,subparagraph,clause,subclause,item,subitem,continuation-text,appropriations-major,appropriations-intermediate,appropriations-small,</xsl:text>
		</xsl:variable>
	...
	<xsl:template match="external-xref">
		<xsl:choose>
			...
			<xsl:when test="./@legal-doc='usc-act'">
				<a>
					<xsl:attribute name="href">
						<xsl:text>/search/?where=everywhere&amp;page=1&amp;query=</xsl:text>
			...
			<xsl:when test="$aCurrElementStyle='OLC' or $aCurrElementStyle=''">
				...
				<xsl:choose>
					...
					<xsl:when test="@level='subdivision'  and not (enum-in-header)">
						<xsl:if test="not(preceding-sibling::*[1]/@level='division')">
							<br/>
						</xsl:if>
					...
					<xsl:when test="./@level='title' ">
						<span class="toctitleOLC">
							<!-- TB Jan2009 break inserted for word presentation -->
							<xsl:if test="not(preceding-sibling::*[1]/@level='division' or preceding-sibling::*[1]/@level='subdivision' )">
								<br/>
							</xsl:if>
							<xsl:call-template name="createLink">
								<xsl:with-param name="val">
					...
					<xsl:when test="./@level='subtitle'  and not(enum-in-header)">
						<xsl:if test="not(preceding-sibling::*[1]/@level = 'title' or preceding-sibling::*[1]/@level='division' or preceding-sibling::*[1]/@level='subdivision' )">
							<br/>
						</xsl:if>
					...
					<xsl:when test="@level='chapter' ">
						<xsl:if test="not(preceding-sibling::*[1]/@level = 'title'  or preceding-sibling::*[1]/@level = 'subtitle'  or preceding-sibling::*[1]/@level = 'part'  or preceding-sibling::*[1]/@level = 'subpart'    or preceding-sibling::*[1]/@level='division' or preceding-sibling::*[1]/@level='subdivision' )">
							<br/>
						</xsl:if>
					...
					<xsl:when test="@level='subchapter' ">
						<xsl:if test="not(preceding-sibling::*[1]/@level = 'title' or preceding-sibling::*[1]/@level = 'subtitle'  or preceding-sibling::*[1]/@level = 'part'  or preceding-sibling::*[1]/@level = 'subpart'  or preceding-sibling::*[1]/@level = 'chapter'   or preceding-sibling::*[1]/@level='division' or preceding-sibling::*[1]/@level='subdivision' )">
							<br/>
						</xsl:if>
					...
					<xsl:when test="@level='part'">
						<xsl:if test="not(preceding-sibling::*[1]/@level = 'title' or preceding-sibling::*[1]/@level = 'subtitle'  or preceding-sibling::*[1]/@level = 'chapter'  or preceding-sibling::*[1]/@level = 'subchapter'  or preceding-sibling::*[1]/@level='division' or preceding-sibling::*[1]/@level='subdivision' )">
							<br/>
						</xsl:if>
					...
					<xsl:when test="@level='subpart' and not (enum-in-header)">
						<xsl:if test="not(preceding-sibling::*[1]/@level = 'title' or preceding-sibling::*[1]/@level = 'subtitle'  or preceding-sibling::*[1]/@level = 'part' or preceding-sibling::*[1]/@level='division' or preceding-sibling::*[1]/@level='subdivision' )">
							<br/>
						</xsl:if>
						<span class="tocsubpartOLC">
							<xsl:call-template name="createLink">
