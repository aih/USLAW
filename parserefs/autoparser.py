...
#   SETTINGS
#location = r'/Users/tabulaw/Documents/workspace/DJANGO/uslaw/codeupdate/newlaws'
...
# For storing to files on disk
#def main():
#    # Compiles regex substitutions
#    findreplace = makergxlist(regfile)
#    
#    # Apply regex to files in the directory at 'location'
#    for fname in os.listdir(location):
#        fullpath = location+"/"+fname
#        with open(fullpath, 'rb') as inputfile:
#            inputfiletxt = inputfile.read()
#            parsedfile = subfile(inputfiletxt, findreplace)
#            with open(fullpath+'-new', 'wb') as outputfile:
#                outputfile.write(parsedfile)
